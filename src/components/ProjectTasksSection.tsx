        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start">
          <div className="flex min-w-0 flex-1 gap-2.5">
            ...
            <div
              role="button"
              tabIndex={busy ? -1 : 0}
              className={`group min-w-0 flex-1 rounded-md px-0.5 py-0.5 text-left outline-none transition-colors cursor-pointer hover:bg-black/[0.06] dark:hover:bg-white/[0.07] focus-visible:ring-2 focus-visible:ring-sky-500 ${
